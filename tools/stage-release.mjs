...
const browserUploadRoot = path.join(releaseRoot, "github-upload-v0.13.6");
const browserDotfilesRoot = path.join(
  releaseRoot,
  "github-dotfiles-upload-v0.13.6",
);
const files = [
  "CHANGELOG.md",
  "LICENSE",
...
if (manifest.version !== "0.13.6") {
  throw new Error(`Expected module version 0.13.6 but found ${manifest.version}.`);
}
if (
...
for (const filename of [
  "chat-card.mjs",
  "cwn-combat-enhancements-v0.13.6.mjs",
