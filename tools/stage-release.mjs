...
const browserUploadRoot = path.join(releaseRoot, "github-upload-v0.17.1");
const browserDotfilesRoot = path.join(
  releaseRoot,
  "github-dotfiles-upload-v0.17.1",
);
const files = [
  "CHANGELOG.md",
  "LICENSE",
...
if (manifest.version !== "0.17.1") {
  throw new Error(`Expected module version 0.17.1 but found ${manifest.version}.`);
}
if (
...
for (const filename of [
  "chat-card.mjs",
  "cwn-combat-enhancements-v0.17.1.mjs",
