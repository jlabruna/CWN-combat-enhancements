...
const browserUploadRoot = path.join(releaseRoot, "github-upload-v0.12.1");
const files = [
  "CHANGELOG.md",
  "LICENSE",
  "MANUAL-TESTS.md",
...
if (manifest.version !== "0.12.1") {
  throw new Error(`Expected module version 0.12.1 but found ${manifest.version}.`);
}
if (
