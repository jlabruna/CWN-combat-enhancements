...
const browserUploadRoot = path.join(releaseRoot, "github-upload-v0.10.6");
const files = [
  "CHANGELOG.md",
  "LICENSE",
  "MANUAL-TESTS.md",
...
if (manifest.version !== "0.10.6") {
  throw new Error(`Expected module version 0.10.6 but found ${manifest.version}.`);
}
if (
